...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'employee.create': {
    roles: ['owner'],
    key: 'admin-added-employee',
    tenantPath: ['company', 'employee'],
    userPath: [],
  },
  'employee.update': {
    roles: ['owner'],
    key: 'admin-updated-employee',
    tenantPath: ['company', 'employee'],
    userPath: [],
  },
  'employee.delete': {
    roles: ['owner'],
    key: 'admin-deleted-employee',
    tenantPath: ['company', 'employee'],
    userPath: [],
  },
  'vacation.create': {
    roles: ['owner'],
    key: 'admin-added-vacation',
    tenantPath: ['company', 'employee', 'vacation'],
    userPath: [],
  },
  'vacation.update': {
    roles: ['owner'],
    key: 'admin-updated-vacation',
    tenantPath: ['company', 'employee', 'vacation'],
    userPath: [],
  },
  'vacation.delete': {
    roles: ['owner'],
    key: 'admin-deleted-vacation',
    tenantPath: ['company', 'employee', 'vacation'],
    userPath: [],
  },
  'payroll.create': {
    roles: ['owner'],
    key: 'admin-added-payroll',
    tenantPath: ['company', 'employee', 'payroll'],
    userPath: [],
  },
  'payroll.update': {
    roles: ['owner'],
    key: 'admin-updated-payroll',
    tenantPath: ['company', 'employee', 'payroll'],
    userPath: [],
  },
  'payroll.delete': {
    roles: ['owner'],
    key: 'admin-deleted-payroll',
    tenantPath: ['company', 'employee', 'payroll'],
    userPath: [],
  },
};
